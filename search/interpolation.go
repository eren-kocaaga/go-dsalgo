...
/*
InterpolationSearch is an improvement over Binary Search for instances,
...
may go to different locations according the value of key being searched. Here
is the source code of the Go program to search element in an integer array using
Interpolation search algorithm. The output shows the position of element in array.
*/
